...
#
# Generated by export_simulation on Thu Apr 28 16:35:04 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './Buffering_Data.sh' script.

./Buffering_Data.sh -reset_run
...
./Buffering_Data.sh -noclean_files

For more information on the script, please type './Buffering_Data.sh -help'.
