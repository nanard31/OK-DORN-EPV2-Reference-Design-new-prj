...
#
# Generated by export_simulation on Tue Apr 12 10:24:14 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './RAM_sum.sh' script.

./RAM_sum.sh -reset_run
...
./RAM_sum.sh -noclean_files

For more information on the script, please type './RAM_sum.sh -help'.
